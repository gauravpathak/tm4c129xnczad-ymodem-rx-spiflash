...
xmodem.obj: ../xmodem.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Compiler'
	"c:/ti/ccsv6/tools/compiler/arm_5.1.5/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me --fp_mode=relaxed --include_path="c:/ti/ccsv6/tools/compiler/arm_5.1.5/include" --include_path="D:/Tiva/TivaWare(129X)" --include_path="D:/Tiva/TivaWare(129X)/examples/boards/dk-tm4c129x" -g --define=ccs="ccs" --define=TARGET_IS_SNOWFLAKE_RA0 --define=PART_TM4C129XNCZAD --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="xmodem.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '

ymodem.obj: ../ymodem.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Compiler'
	"c:/ti/ccsv6/tools/compiler/arm_5.1.5/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me --fp_mode=relaxed --include_path="c:/ti/ccsv6/tools/compiler/arm_5.1.5/include" --include_path="D:/Tiva/TivaWare(129X)" --include_path="D:/Tiva/TivaWare(129X)/examples/boards/dk-tm4c129x" -g --define=ccs="ccs" --define=TARGET_IS_SNOWFLAKE_RA0 --define=PART_TM4C129XNCZAD --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="ymodem.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
